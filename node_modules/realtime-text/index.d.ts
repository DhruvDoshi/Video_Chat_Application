...
export declare type RTTAction = EraseAction | InsertAction | WaitAction;
...
export declare class DisplayBuffer {
     ...
     */
    private erase(length?, position?);
    private emitState(additional?);
    /**
...
export declare class InputBuffer {
     ...
     */
    start(resetInterval?: number): RTTEvent;
    /**
