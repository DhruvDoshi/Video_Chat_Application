...
async function retryRequest(url, opts, timeout, allowedRetries) {
    try {
        const resp = await Utils_1.timeoutPromise(fetch_1.default(url, opts), timeout * 1000);
        if (!resp.ok) {
...
class BOSHConnection extends WildEmitter_1.default {
    constructor(sm, stanzas) {
        super();
        const self = this;
        self.sm = sm;
        self.stanzas = {
            BOSH: stanzas.getDefinition('body', protocol_1.Namespaces.BOSH),
