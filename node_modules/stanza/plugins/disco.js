...
function generateVerString(info, hash) {
    ...
    identities = [...new Set(identities)].sort(Utils_1.octetCompare);
    features = [...new Set(features)].sort(Utils_1.octetCompare);
    ...
    formOrder.sort(Utils_1.octetCompare);
    for (const name of formOrder) {
        ...
        for (const field of ext.fields) {
            ...
            if (fieldName !== 'FORM_TYPE') {
                ...
                fields[fieldName] = values.sort(Utils_1.octetCompare);
                fieldOrder.push(fieldName);
            }
        }
        fieldOrder.sort(Utils_1.octetCompare);
...
function default_1(client) {
    ...
    client.disco.addFeature(protocol_1.Namespaces.DISCO_INFO);
    client.disco.addFeature(protocol_1.Namespaces.DISCO_ITEMS);
