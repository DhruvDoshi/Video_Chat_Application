...
function default_1(client) {
    ...
    client.disco.addFeature(protocol_1.Namespaces.JINGLE_1);
    if (root && root.RTCPeerConnection) {
        const caps = [
            protocol_1.Namespaces.JINGLE_RTP_1,
            protocol_1.Namespaces.JINGLE_RTP_RTCP_FB_0,
            protocol_1.Namespaces.JINGLE_RTP_HDREXT_0,
            protocol_1.Namespaces.JINGLE_RTP_SSMA_0,
            protocol_1.Namespaces.JINGLE_DTLS_0,
            protocol_1.Namespaces.JINGLE_GROUPING_0,
            protocol_1.Namespaces.FILE_TRANSFER_3,
            protocol_1.Namespaces.JINGLE_ICE_UDP_1,
            protocol_1.Namespaces.JINGLE_RTP_AUDIO,
            protocol_1.Namespaces.JINGLE_RTP_VIDEO,
