...
function default_1(client) {
    client.disco.addFeature(protocol_1.Namespaces.MAM_2);
    ...
    client.searchHistory = function (opts, cb) {
        ...
        for (const name of defaultFields) {
            if (opts[name] || name === 'FORM_TYPE') {
                ...
                if (name === 'FORM_TYPE') {
                    val = protocol_1.Namespaces.MAM_2;
                }
        ...
        const dest = new jid_1.JID(to || client.jid.bare);
        const allowed = {};
        allowed[''] = true;
        ...
        return Utils_1.timeoutPromise(mamQuery, this.config.timeout * 1000 || 15000, () => ({
            error: {
                condition: 'timeout'
            },
            id: queryid,
